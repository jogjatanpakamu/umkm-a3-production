                ...
                <div class="card-content">
                  <div class="card-body">
                    ...
                    <form method="POST" enctype="multipart/form-data" action="upload_bukti.php">
                      <input type="text" name="pesid" value="<?= $_GET['pesid'] ?>">
                      <fieldset>
                        <div class="input-group mb-4">
                          <input type="file" class="form-control" name="bukti_bayar" id="bukti_bayar" aria-describedby="inputGroupFileAddon04" aria-label="Upload">
                        </div>
                      </fieldset>
