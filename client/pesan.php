        ...
        <section class="section">
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    <label for="helperText">Panduan Ukuran</label>
          ...
          <div class="card">
            ...
            <div class="card-content">
              <div class="card-body">
                <p>
                  Pesanan akan di proses jika Pembayaran minimal
                  <code><b>50%</b></code> dari pembelian
                </p>
                <form name="form_pembayaran" method="post">
                  <input type="radio" class="btn-check" value="bca" name="bank" id="bca" autocomplete="off" />
                  <label class="btn btn-outline-primary" for="bca">BCA</label>

                  <input type="radio" class="btn-check" value="bri" name="bank" id="bri" autocomplete="off" />
                  <label class="btn btn-outline-danger" for="bri">BRI</label>

                  <input type="radio" class="btn-check" value="dana" name="bank" id="dana" autocomplete="off" />
                  <label class="btn btn-outline-danger" for="dana">DANA</label>
                </form>
              </div>
            </div>
          </div>
